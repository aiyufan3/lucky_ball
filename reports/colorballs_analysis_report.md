...
## 📊 报告信息
- **生成时间**: 2025年09月02日 20:18:28 (UTC+8)
- **数据期数**: 共 1907 期
- **下一期开奖日(按周)**: 周四
- **最新期号**: 2025100
- **数据来源**: 中国福利彩票官方API
...
**推荐组合 1** (ML低熵): 05 06 14 17 18 28 + **14**
- 特征: 2奇4偶 | 和值:88 | 跨度:23
- 信息熵: 2.5641 bits
- 置信度(相对): 0.002652
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 2** (ML低熵): 06 11 14 17 27 32 + **14**
- 特征: 3奇3偶 | 和值:107 | 跨度:26
- 信息熵: 2.5787 bits
- 置信度(相对): 0.002847
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 3** (ML低熵): 06 11 14 17 18 19 + **15**
- 特征: 3奇3偶 | 和值:85 | 跨度:13
- 信息熵: 2.5785 bits
- 置信度(相对): 0.003422
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 4** (ML低熵): 06 14 17 23 27 31 + **15**
- 特征: 4奇2偶 | 和值:118 | 跨度:25
- 信息熵: 2.5698 bits
- 置信度(相对): 0.00327
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 5** (ML低熵): 05 06 14 17 24 33 + **15**
- 特征: 3奇3偶 | 和值:99 | 跨度:28
- 信息熵: 2.57 bits
- 置信度(相对): 0.003267
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 6** (ML低熵): 06 14 17 26 31 32 + **14**
- 特征: 2奇4偶 | 和值:126 | 跨度:26
- 信息熵: 2.5692 bits
- 置信度(相对): 0.002701
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 7** (ML低熵): 06 10 11 17 22 28 + **16**
- 特征: 2奇4偶 | 和值:94 | 跨度:22
- 信息熵: 2.5722 bits
- 置信度(相对): 0.002301
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合

**推荐组合 8** (ML低熵): 06 11 17 27 31 33 + **14**
- 特征: 5奇1偶 | 和值:125 | 跨度:27
- 信息熵: 2.571 bits
- 置信度(相对): 0.002723
- 说明: LSTM+ARIMA+MonteCarlo 低熵组合
...
*报告生成时间: 2025年09月02日 20:18:28 (UTC+8)*
*数据来源: 中国福利彩票官方网站*
*仅供学习研究使用，请理性购彩*
